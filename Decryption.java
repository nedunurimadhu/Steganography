...
class decryptionLayout implements LayoutManager {
    ...
    public void layoutContainer(Container parent) {
        ...
        if (c.isVisible()) {c.setBounds(insets.left+500,insets.top+500,104,32);}
        c = parent.getComponent(4);//next
        if (c.isVisible()) {c.setBounds(insets.left+700,insets.top+500,104,32);}
        c = parent.getComponent(5);//source box
        ...
        c = parent.getComponent(7);//message box
