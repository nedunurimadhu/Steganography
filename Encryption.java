...
class EncryptionLayout implements LayoutManager {
    ...
    public Dimension preferredLayoutSize(Container parent) {
        ...
        dim.width = 2000 + insets.left + insets.right;
    ...
    public void layoutContainer(Container parent) {
        ...
        if (c.isVisible()) {c.setBounds(insets.left+360,insets.top+230,112,32);}
        c = parent.getComponent(1);
        if (c.isVisible()) {c.setBounds(insets.left+360,insets.top+300,112,32);}
        c = parent.getComponent(2);
        if (c.isVisible()) {c.setBounds(insets.left+88,insets.top+160,112,32);}
        c = parent.getComponent(3);//back
        if (c.isVisible()) {c.setBounds(insets.left+445,insets.top+500,104,32);}
        c = parent.getComponent(4);//next
        if (c.isVisible()) {c.setBounds(insets.left+600,insets.top+500,104,32);}
        c = parent.getComponent(5);//sourse textarea
        if (c.isVisible()) {c.setBounds(insets.left+470,insets.top+230,390,32);}
        c = parent.getComponent(6);//message textbox
        if (c.isVisible()) {c.setBounds(insets.left+470,insets.top+300,390,150);}
        c = parent.getComponent(7);
        if (c.isVisible()) {c.setBounds(insets.left+200,insets.top+160,284,52);}
        c = parent.getComponent(8);//browse
        if (c.isVisible()) {c.setBounds(insets.left+920,insets.top+230,104,32);}
        c = parent.getComponent(9);//clear
        if (c.isVisible()) {c.setBounds(insets.left+920,insets.top+300,104,32);}
        c = parent.getComponent(10);//save
        if (c.isVisible()) {c.setBounds(insets.left+755,insets.top+500,104,32);}
